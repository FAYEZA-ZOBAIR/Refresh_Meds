...
<?php
    ...
    $sql="select * from user_med_donation where med_validation_type= '".$status."' ";
    loadFromMySQL($sql);
	foreach($data as $v){
	?>
	...
	<tr>
                    ...
                    <th><p ><?php echo $v["med_id"]; ?></p></th>
                    <th><p ><?php echo $v["med_name"]; ?></p></th>
                    <th><p><?php echo $v["med_type"]; ?></p></th>
                    <th><p><?php echo $v["med_quantity"]; ?></p></th>
                    <th><p><?php echo $v["med_quantity_a"]; ?></p></th>
                    <th><p ><?php echo $v["med_ddate"]; ?></p></th>
                    <th><p><?php echo $v["med_edate"]; ?></p></th>
                    <th><p ><?php echo $v["med_location"]; ?></p></th>
...
<form action="medprocess.php" name="fm">
                  <h2 style="text-align:center">Volunteer: <select id="activeList" name="active" onchange="load_location(this);">
				   ...
				   ?>
					...
					<h2 style="text-align:center">Medicine ID: <input type="text" name="fid" placeholder="Enter medicine id"><h2>
